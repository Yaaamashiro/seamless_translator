...
OUT=ROOT/"artifacts"/"gemma-qwen-check";OUT.mkdir(parents=True,exist_ok=True)
config=load_config(ROOT/"config.qwen.yaml")
...
try:
 ...
 for source,target,text in [("ja","en","駅はどこですか？"),("en","ja","Could you speak more slowly?")]:
